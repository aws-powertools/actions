...
module.exports = async ({ github, context, core }) => {
	...
	if (isMatch == null) {
		...
		const msg =
			"No acknowledgement section found. Please make sure you used the template to open a PR and didn't remove the acknowledgment section. Check the template here: https://github.com/aws-powertools/actions/blob/main/.github/PULL_REQUEST_TEMPLATE.md#acknowledgment";
