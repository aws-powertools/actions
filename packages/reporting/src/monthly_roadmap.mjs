...
export async function createMonthlyRoadmapReport(options = {}) {
	const { github = new GitHub({}), actions = new GitHubActions() } = options;

	actions.core.info("Fetching GitHub data concurrently");
...
> generated by: ${actions.getWorkflowRunUrl()}
  `;
	...
	actions.core.info("Creating issue with monthly roadmap report");
